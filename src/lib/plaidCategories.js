/**
 * Complete Plaid v2 Personal Finance Category taxonomy.
 * Map of primary category → array of detailed subcategories.
...
export const PLAID_CATEGORIES = {
  ...
  SUBSCRIPTION: [
    'SUBSCRIPTION_STREAMING_SERVICES',
    'SUBSCRIPTION_SOFTWARE_AND_APPS',
    'SUBSCRIPTION_NEWS_AND_PUBLICATIONS',
    'SUBSCRIPTION_MUSIC',
    'SUBSCRIPTION_GAMING',
    'SUBSCRIPTION_CLOUD_STORAGE',
    'SUBSCRIPTION_FITNESS_AND_WELLNESS',
    'SUBSCRIPTION_MEAL_KITS_AND_DELIVERY',
    'SUBSCRIPTION_MEMBERSHIP_FEES',
    'SUBSCRIPTION_OTHER_SUBSCRIPTION',
  ],
  LOAN_DISBURSEMENTS: [
...
export const PRIMARY_CATEGORIES = Object.keys(PLAID_CATEGORIES)
